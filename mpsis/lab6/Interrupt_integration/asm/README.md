...
| 0x00578793    | addi x15, x15, 0x5             | Добавление 0x5 к x15 (x15 = 0x29005)                                              | 50-70      |                                   |
| 0x00f02023    | sw x15, 0(x0)                  | Сохранение значения x15 (0x29005) по адресу 0x0                                   | 70-110     |                                   |
| 0x000000b7    | lui x1, 0x00000                | Загрузка верхних 20 бит (0x00000) в x1                                            | 110-130    | x1 = 0x00000                      |
| 0x00508093    | addi x1, x1, 0x5               | Добавление 0x5 к x1 (x1 = 0x00005)                                                | 130-150    |                                   |
| 0x00002103    | lw x2, 0(x0)                   | Чтение из памяти по адресу 0x0 в x2 (x2 = 0x29005)                                | 150-190    |                                   |
| 0x00700193    | addi x3, x0, 7                 | Инициализация x3 = 7 (маска)                                                      | 190-210    |                                   |
| 0x00000213    | addi x4, x0, 0                 | Инициализация x4 = 0 (счетчик сдвига)                                             | 210-230    |                                   |
| 0x00000293    | addi x5, x0, 0                 | Инициализация x5 = 0 (временная переменная)                                       | 230-250    |                                   |
| 0x00100313    | addi x6, x0, 1                 | Инициализация x6 = 1 (константа)                                                  | 250-270    |                                   |
| 0x00000393    | addi x7, x0, 0                 | Инициализация x7 = 0 (временная переменная)                                       | 270-290    |                                   |
| 0x00000413    | addi x8, x0, 0                 | Инициализация x8 = 0 (результат)                                                  | 290-310    |                                   |
| 0x00300493    | addi x9, x0, 3                 | Инициализация x9 = 3 (константа)                                                  | 310-330    |                                   |
| 0x00000513    | addi x10, x0, 0                | Инициализация x10 = 0 (константа для сравнения)                                   | 330-350    |                                   |
| 0x00317133    | and x2, x2, x3                 | Применение маски 0x7 к x2 (x2 = x2 & 0x7)                                         | 350-370    |                                   |
| 0x0030f2b3    | and x5, x1, x3                 | Применение маски 0x7 к x1 (x5 = x1 & 0x7)                                         | 370-390    |                                   |
| 0x02510063    | beq x2, x5, 32                 | Переход на match_case если x2 == x5                                                | 390-410    |                                   |
| 0x0060f3b3    | and x7, x1, x6                 | x7 = x1 & 0x1 (младший бит x1)                                                    | 410-430    |                                   |
| 0x004393b3    | sll x7, x7, x4                 | x7 = x7 << x4 (сдвиг на значение счетчика)                                        | 430-450    |                                   |
| 0x00746433    | or x8, x8, x7                  | x8 = x8 | x7 (накопление результата)                                          | 450-470    |                                   |
| 0x00620233    | add x4, x4, x6                 | x4 = x4 + 1 (инкремент счетчика)                                                  | 470-490    |                                   |
| 0x0010d093    | srli x1, x1, 1                 | x1 = x1 >> 1 (сдвиг вправо на 1 бит)                                              | 490-510    |                                   |
| 0xfea090e3    | bne x1, x10, -32               | Переход на loop_start если x1 != 0                                                 | 510-530    |                                   |
| 0x0000006f    | jal x0, 0                      | Бесконечный цикл (вывод x8)                                                       | 530-550    |                                   |
| 0x0030d093    | srli x1, x1, 3                 | x1 = x1 >> 3 (сдвиг вправо на 3 бита)                                             | 550-570    |                                   |
| 0xfca09ae3    | bne x1, x10, -44               | Переход на loop_start если x1 != 0                                                 | 570-590    |                                   |
