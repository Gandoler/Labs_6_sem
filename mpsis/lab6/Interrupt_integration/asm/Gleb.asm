lui x15, 0x29 # x15 = 101001
addi x15, x15, 0x5 # x15 += const
sw x15, 0x0(x0) #загружаем

# x1 = a (константа 0x00000514)
lui x1, 0x00000        # Загружаем старшие биты (но в данном случае они нулевые)
addi x1, x1, 0x5     # x1 = 101: a
