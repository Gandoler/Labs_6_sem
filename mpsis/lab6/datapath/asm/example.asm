...
04:  addi  x2,  x0, 0x8A7       //  Загружает в регистр x2 значение 0x8A7 (-1881 в десятичной системе).                                              2
08:  add   x3,  x1, x2          //  Складывает значения x1 (1884) и x2 (-1881), результат (0x1003 или 4099) записывает в x3                          3
...
68:  jalr  x18, 0x4(x15)        //  Прыжок на адрес x15 + 4 (0x1C + 4 = 0x24), сохраняя адрес возврата (0x6C) в x18                                 8
