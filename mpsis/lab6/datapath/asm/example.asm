...
08:  add   x3,  x1, x2          //  Складывает значения x1 (1884) и x2 (-1881), результат (0x1003 или 4099) записывает в x3                         3        (0x002081B3)
0C:  and   x4,  x1, x2          //  Побитовое И между x1 (0x75C) и x2 (0x8A7), результат (0x04) записывается в x4.                                  4        (0x0020F233)  
10:  sub   x5,  x4, x3          //  Вычитает x3 (4099) из x4 (0x04 = 4), результат (4095) записывается                                              5        (0x403202B3)
