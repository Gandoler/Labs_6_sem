// 29 variant
//J  B  WS  const                                   WA
 0  0  00  00000000001010001000101                 00001    // reg[1] = a записываем константу в регист 1                                         вывод нуля
...
//J  B  WS  const                                   WA
 0  0  00  00000000000000000000000                 00100    // reg[4] = переменная переноса будет и будет -1 в начале                             вывод нуля
...
//if
//J  B  WS  ALUOp   RA1     RA2      offset         comand_const
 0  1  01  11001   00001   01010    11111001       00000 // сравниваем a и 0 если a!=0 прыгаем обратно на команду получения правых 3 бит a        вывод reg[1]
