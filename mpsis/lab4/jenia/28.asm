...
//J  B  WS  const                                   WA
 0  0  00  00000000000000000000001                 00110  // reg[6] = 1 записываем константу в регист 5 для формулы an = a1 + (n-1)*d           вывод нуля   

//J  B  WS  comand_const                            WA
 0  0  11  00000000000000000000000                 00010  //reg[2] = 0 блягодяря alu                                                            вывод нуля

//J  B  WS  comand_const                            WA
 0  0  11  00000000000000000000000                 00101  //reg[5] = 0 блягодяря alu                                                            вывод нуля

//J  B  WS  ALUOp   RA1     RA2      comand_const   WA
 0  0  01  01000   00100   00110    00000000       00100 // reg[4] = reg[4]-reg[5] или n-1                                                      вывод reg[4]

//J  B  WS  ALUOp   RA1     RA2      comand_const   WA 
 0  0  01  00000   00101   00100    00000000       00101 // reg[5] = reg[5] + reg[4]                                                            вывод reg[5]

//J  B  WS  ALUOp   RA1     RA2      comand_const   WA
 0  0  01  01000   00011   00110    00000000       00011 // reg[3] = reg[3] - 1                                                                 вывод reg[3]

//J  B  WS  ALUOp   RA1     RA2      offset         comand_const
 0  1  01  11100   00010   00011    11111110       00000 // d>0 тогда переместимся на две команды назад                                         вывод reg[2]
