...
## **Вывод**
В данной лабораторной работе мы реализовали алгоритм RSA, включая:  
- Генерацию ключей.  
- Шифрование и расшифровку сообщений.  
- Применение алгоритмов Евклида и быстрого возведения в степень.  

Программа корректно шифрует и расшифровывает текст, используя асимметричную криптографию.
