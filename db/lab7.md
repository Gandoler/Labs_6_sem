...
3. **Уникальность:** Каждый `student_id` уникален, что делает его идеальным кандидатом для индексирования. Уникальные значения обеспечивают высокую эффективность индекса.
